...
const contacts = [
  ...
  { icon: mail, contact: "contact-solarone@gmail.com" },
  {
    icon: location,
  ...
  return (
    ...
    >
      <div className="flex flex-col p-[2em] bg-dark gap-[4em] flex-1 rounded-2xl">
        ...
        <div className="text-[0.8em] flex flex-col gap-[2em]">
          {contacts.map((item, index) => {
            return (
              <div key={index} className="flex gap-[1em]">
                <img src={item.icon} alt="" className="w-[1.3em]" />{" "}
                <p>{item.contact}</p>
              </div>
            );
          })}
        ...
        <div className="flex gap-[2em] items-center">
          <div
            onMouseOver={() => setIsDark1(true)}
            onMouseOut={() => setIsDark1(false)}
            className={`p-3 bg-slate-700 rounded-full cursor-pointer hover:bg-white transition duration-300 `}
          >
            <svg
              width="15"
              height="12"
            ...
            >
              <path
                ...
                fill={isDark1 ? "black" : "white"}
              />
            </svg>
          </div>
          <div
            onMouseOver={() => setIsDark2(true)}
            onMouseOut={() => setIsDark2(false)}
            className={`p-3 bg-slate-700 rounded-full cursor-pointer hover:bg-white transition duration-300 `}
          >
            <svg
              width="15"
            ...
            >
              <path
                ...
                fill={isDark2 ? "black" : "white"}
              />
            </svg>
          </div>
          <div
            onMouseOver={() => setIsDark3(true)}
            onMouseOut={() => setIsDark3(false)}
            className={`p-3 bg-slate-700 rounded-full cursor-pointer hover:bg-white transition duration-300 `}
          >
            <svg
              width="15"
