...
export const Hero = () => {
  return (
    <div className="bg-blue-400 bg-hero-small md:bg-hero-large bg-cover bg-center">
      <div
        id="overlay"
        className="bg-gradient-to-b from-[#0a50c9] to-[rgba(224,224,224,0.7)] h-full w-full pt-[2em] pb-[10em] px-[1em] lg:px-[8em]"
      >
        <div className="flex  flex-col">
          ...
          <div className="lg:px-[4em] flex md:justify-center mb-[4em]">
            <p className="text-[1.7em] md:text-[2.5em] max-w-[15em]">
          ...
          <div className="max-w-[30em] text-[1em]">
            ...
            <div>
              <Link
                to={"/contact-us"}
                className="items-center py-3 px-4 bg-white text-blue-600 rounded-xl mr-4 bg-opacity-90 hover:bg-opacity-100"
              >
                Call us Today
              </Link>
              <Link
                to={"/contact-us"}
                className="items-center py-3 px-4 bg-[#fcbe03] text-white rounded-xl mr-4 bg-opacity-90 hover:bg-opacity-100"
              >
                Request a call back
              </Link>
            </div>
